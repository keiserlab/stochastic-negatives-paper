...
def main():
    ...
    parent_dir = os.path.join(neg_rm_dir, "STD_SMA_RATIOS")
    trained_dirs = glob(os.path.join(parent_dir, fold_tmplt))
    
    experiments = []
    converged_epochs = ("{}/output/20180815_Paper_Retrains/predictions/STD_SMA_RATIOS/experiments_edited.json".format(home_save_dir))
    ...
    outdir = "{}/output/20180815_Paper_Retrains/predictions/STD_SMA_RATIOS".format(home_save_dir)
