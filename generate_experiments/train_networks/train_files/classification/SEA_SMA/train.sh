...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/classification/SEA_SMA";
...
for fold in {0..4}; do
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/lr_nesterov_binary_classifier_1024_2048_3072.py classifier_sea_sneg CLASSIFIER_SEA_SMA
done
