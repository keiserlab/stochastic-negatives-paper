...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/classification";
curr_env="mygpu1"
...
script_run="python ${args_path}/SEA_SMA/run_with_custom_epochs.py"  
