...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/classification_lower_lr/NEG_RM_SMA_lr01";
...
for fold in {0..4}; do
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/classification_negs_rm.py classifier_sneg CLASSIFIER_NEG_RM_SMA_RATIOS_LR01
done
