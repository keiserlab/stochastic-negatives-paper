...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/classification_lower_lr/STD_lr_01";
...
for fold in {0..4}; do
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/lr_nesterov_binary_classifier_1024_2048_3072.py classifier_no_sneg CLASSIFIER_STD_LR01
done
