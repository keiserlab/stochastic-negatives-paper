...
sea_lib=$HOME_SAVE_BASE"/output/20180815_Paper_Retrains/SEA_GEN/binding/chembl20_binding_ecfp4_4096.sea";

# output files
out_base=$HOME_SAVE_BASE"/output/20180815_Paper_Retrains/SEA_GEN/binding/preds";
mkdir -p $out_base;
...
# log info
# reference files
the_deets="lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/SEA_GEN";
