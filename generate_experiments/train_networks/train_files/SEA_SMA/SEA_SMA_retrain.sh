...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/SEA_SMA/";
...
for fold in {0..4}; do
  run_experiment ${fold} ${NNET_BASE}/experiments/lr_nesterov_1024_2048_3072.py sneg SEA_SMA
done
