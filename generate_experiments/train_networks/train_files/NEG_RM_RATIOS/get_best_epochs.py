...
def combin:qe_common_results(results_list):
    res_dict = []
...
def main():
    ...
    for ratio in sneg_pnrs: 
        print(ratio)
        expt_name = "NEG_RM_RATIO_{}".format(ratio)
        print(expt_name)
    ...
    # datasets
    train_dir = "{}/output/20180815_Paper_Retrains/trained_nets/all_negs_stochastic/NEG_RM_RATIOS/fold_0/pnr_1.0".format(home_save_dir)
    ...
    outdir = "{}/output/20180815_Paper_Retrains/predictions".format(home_save_dir)
