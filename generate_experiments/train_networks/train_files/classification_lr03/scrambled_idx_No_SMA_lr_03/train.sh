...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/classification_lr03/scrambled_idx_No_SMA_lr_03";
...
for fold in {0..4}; do
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/lr_nesterov_binary_classifier_1024_2048_3072.py no_sneg CLASSIFIER_scrambled_idx_No_SMA_LR03
done
