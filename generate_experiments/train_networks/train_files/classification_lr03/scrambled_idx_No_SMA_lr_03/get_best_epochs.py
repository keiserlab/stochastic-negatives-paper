...
def main():
    ...
    expt_base="CLASSIFIER_scrambled_idx_No_SMA_LR03"
    
    sneg_pnrs=[1.0]
    fold_tmplt = "fold_[0-9]*/pnr_*/"
    
    loss_dir = "{}/output/20180815_Paper_Retrains/trained_nets".format(home_save_dir)
    sub_dir = "{}/lr_nesterov_binary_classifier_1024_2048_3072/".format(loss_dir)
    ...
    parent_dir = os.path.join(sub_dir, expt_base)
