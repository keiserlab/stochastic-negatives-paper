...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/classification_lr03/NEG_RM_SMA_lr_03";
...
#sneg_pnrs=(0.25 1.2222 1.5)
#sneg_pnrs=(0.4286 1.2222 1.5)
sneg_pnrs=(0.25)

for fold in {2..2}; do
  for pnr in ${sneg_pnrs[@]}; do
    run_experiment ${fold} ${NNET_BASE}/experiments/classification/classification_negs_rm.py ${pnr} CLASSIFIER_NEG_RM_SMA_RATIOS_LR03
  done
done
