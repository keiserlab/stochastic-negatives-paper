...
def main():
    expt_base="CLASSIFIER_NEG_RM_SMA_RATIOS_LR03"
    ...
    # network
    network_script = '{}/labgits/neural-nets/experiments/classification/classification_negs_rm.py'.format(proj_dir)
    
    # datasets
    train_dir = "{}/output/20180815_Paper_Retrains/trained_nets/classification_negs_rm/{}/fold_0/pnr_1.0".format(home_save_dir, expt_base)
