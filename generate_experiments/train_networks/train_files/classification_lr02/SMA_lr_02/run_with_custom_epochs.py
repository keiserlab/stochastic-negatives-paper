...
def main():
    expt_base="CLASSIFIER_SMA_RATIOS_LR02"
    ...
    # datasets
    train_dir = "{}/output/20180815_Paper_Retrains/trained_nets/lr_nesterov_binary_classifier_1024_2048_3072/{}/fold_0/pnr_4.0".format(home_save_dir, expt_base)
