...
def main():
    ...
    expt_base="scrambled_idx_no_SMA"
    sneg_pnrs=[1.0]
    ...
    network_script = '{}/neural-nets/experiments/lr_nesterov_1024_2048_3072.py'.format(proj_dir)

    # datasets

    train_dir = "{}/output/20180815_Paper_Retrains/trained_nets/lr_nesterov_1024_2048_3072/{}/fold_0/pnr_1.0".format(home_save_dir, expt_base)
