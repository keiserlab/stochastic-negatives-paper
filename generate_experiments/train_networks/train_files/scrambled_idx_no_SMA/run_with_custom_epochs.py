...
def main():
    ...
    neg_rm_dir = "{}/lr_nesterov_1024_2048_3072/".format(loss_dir)

    experiments = []
    expt_name = "scrambled_idx_no_SMA"

    parent_dir = os.path.join(neg_rm_dir, expt_name)
    trained_dirs = glob(os.path.join(parent_dir, fold_tmplt))
    
    experiments = []
    converged_epochs = ("{}/output/20180815_Paper_Retrains/predictions/{}/experiments_edited.json".format(home_save_dir, expt_name))
    ...
    # network
    network_script = '/srv/home/nmew/myprojects/neural-nets/experiments/lr_nesterov_1024_2048_3072.py'
    # datasets
    
    scrambled_data_dir = "{}/output/20180815_Paper_Retrains/scrambled_idx".format(home_save_dir)
    train_dir = "{}/output/20180815_Paper_Retrains/trained_nets/lr_nesterov_1024_2048_3072/STD_SMA_RATIOS/fold_0/pnr_1.0".format(home_save_dir)
    new_timesplit_dir = '{}/20180525_DM_scrubbing/train_data/'.format(srv_save_dir)
    new_timesplit_train = os.path.join(scrambled_data_dir,"SCRAMBLED_train_ts2012_chembl20_MWmax800_scrubDM_minpos10_cutoff5.hdf5")
    ...
    outdir = "{}/output/20180815_Paper_Retrains/predictions/{}".format(home_save_dir, expt_name)
