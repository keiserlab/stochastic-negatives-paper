...
args_path=$HOME"/labgits/lab-notebook-caceres/Projects/nnets/20180815_Paper_Retrains/scrambled_idx_no_SMA/";
...
for fold in {0..4}; do
  run_experiment ${fold} ${NNET_BASE}/experiments/lr_nesterov_1024_2048_3072.py no_sneg scrambled_idx_no_SMA
done
