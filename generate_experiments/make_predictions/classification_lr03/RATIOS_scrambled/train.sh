...
run_experiment () {
  ...
  sneg_pnrs=(1.2222 0.8182 1.5 2.3333 0.6666 0.4286 0.25 0.1111 0.0753)
...
for fold in {0..4}; do
 # run the SMA models
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/lr_nesterov_binary_classifier_1024_2048_3072.py classifier_sneg_scrambled CLASSIFIER_SMA_RATIOS_scrambled_LR03
  
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/classification_negs_rm.py classifier_sneg_scrambled CLASSIFIER_NEG_RM_SMA_RATIOS_scrambled_LR03
done
