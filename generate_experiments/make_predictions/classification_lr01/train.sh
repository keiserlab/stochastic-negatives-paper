...
expt_base=$DATA_SAVE_BASE"/20190410_SMA_Investigation";
...
for fold in {0..4}; do
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/lr_nesterov_binary_classifier_1024_2048_3072.py classifier_sneg_lr01 CLASSIFIER_SMA_RATIOS_LR01
  
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/classification_negs_rm.py classifier_sneg_lr01 CLASSIFIER_NEG_RM_SMA_RATIOS_LR01
  
   # run the SMA models
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/lr_nesterov_binary_classifier_1024_2048_3072.py classifier_sneg_scrambled_lr01 CLASSIFIER_SMA_RATIOS_scrambled_LR01
  
  run_experiment ${fold} ${NNET_BASE}/experiments/classification/classification_negs_rm.py classifier_sneg_scrambled_lr01 CLASSIFIER_NEG_RM_SMA_RATIOS_scrambled_LR01
