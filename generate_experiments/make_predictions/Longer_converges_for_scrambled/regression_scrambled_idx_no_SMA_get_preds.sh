...
expt_name="scrambled_idx_no_SMA_longer_converge";
...
scrambled_dir="${HOME_SAVE_BASE}/output/20180815_Paper_Retrains/scrambled_idx/"
hdf5_train="${scrambled_dir}SCRAMBLED_train_ts2012_chembl20_MWmax800_scrubDM_minpos10_cutoff5.hdf5";
...
pred_call="python ${get_preds_script} ${hdf5_train} ${hdf5_ts} ${target_map_file} ${out_dir} ${converged_epochs_json} &> ${out_dir}/get_preds.log & pid=$!"3
